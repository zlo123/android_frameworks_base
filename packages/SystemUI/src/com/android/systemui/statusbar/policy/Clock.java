...
public class Clock extends TextView implements OnClickListener, OnLongClickListener {
    ...
    private void updateSettings(){
        ...
        mNewClockColor = Settings.System.getInt(resolver,
                Settings.System.STATUS_BAR_CLOCK_COLOR, mClockColor);

        if (mNewClockColor < 0 && mNewClockColor != mClockColor) {
            mClockColor = mNewClockColor;
